...
export const registerAccount = (request: RegisterRequest) =>
  apiClient.post<RegisterResponse>('/auth/register', request)
export const loginAccount = (request: LoginRequest) =>
...
export const updateProfile = (request: ProfileUpdateRequest) =>
  apiClient.put<ProfileResponse>('/users/me', request)
export const changePassword = (request: PasswordChangeRequest) =>
  apiClient.put<void>('/auth/password', request)
