...
- **Heading Font:** Be Vietnam Pro (700–800)
- **Body Font:** Noto Sans Variable (400–700)
- **Mood:** Vietnamese-friendly, trustworthy, clean, readable, professional
- **Loading:** Self-hosted through `@fontsource/be-vietnam-pro` and `@fontsource-variable/noto-sans` so typography does not depend on a third-party CDN.
